    ...
    <Container>
      ...
      <Segment color='red'>
        <Grid columns={3} textAlign="right">
          <Grid.Row>
            ...
            <Grid.Column width={3} alignSelf="center">$10,00</Grid.Column>
            <Grid.Column width={3}>
      ...
      <Segment color='green'>
        <Grid columns={3} textAlign="right">
          <Grid.Row>
            ...
            <Grid.Column width={3} alignSelf="center">$91,09</Grid.Column>
            <Grid.Column width={3}>
              <Icon name='edit' bordered />
              <Icon name='trash' bordered />
            </Grid.Column>
      ...
      <Segment color='red'>
        <Grid columns={3} textAlign="right">
          <Grid.Row>
            <Grid.Column width={10} textAlign="left">Something Else</Grid.Column>
            <Grid.Column width={3} alignSelf="center">$70,99</Grid.Column>
            <Grid.Column width={3}>
              <Icon name='edit' bordered />
              <Icon name='trash' bordered />
            </Grid.Column>
